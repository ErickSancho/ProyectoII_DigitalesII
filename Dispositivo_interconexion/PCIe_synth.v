...
(* src = "FIFO/control_logic.v:1.1-91.10" *)
module \$paramod\control_logic\MEM_SIZE=16 (full_threshold, empty_threshold, fifo_synth_rd, fifo_synth_wr, clk, reset_L, error, almost_empty, almost_full, fifo_synth_full, fifo_synth_empty);
  ...
  (* src = "FIFO/control_logic.v:48.1-89.4" *)
  DFF _310_ (
    .C(clk),
    .D(_000_),
    .Q(counter[0])
...
(* dynports =  1  *)
(* hdlname = "\\fifo_synth" *)
(* src = "FIFO/fifo_synth.v:1.1-85.10" *)
module \$paramod\fifo_synth\MEM_SIZE=16 (fifo_synth_data_out, error, almost_empty, almost_full, fifo_synth_full, fifo_synth_empty, fifo_synth_wr, fifo_synth_rd, fifo_synth_data_in, full_threshold, empty_threshold, clk, reset_L);
  ...
  input clk;
  (* src = "FIFO/fifo_synth.v:78.24-78.34" *)
  wire [5:0] data_in_MM;
  ...
  wire [4:0] wr_ptr;
  (* src = "FIFO/fifo_synth.v:51.38-64.26" *)
  ...
  (* src = "FIFO/fifo_synth.v:66.31-76.22" *)
  ...
  (* src = "FIFO/fifo_synth.v:41.35-49.27" *)
  ...
  (* src = "FIFO/fifo_synth.v:31.36-39.29" *)
...
(* dynports =  1  *)
(* hdlname = "\\read_logic" *)
(* src = "FIFO/read_logic.v:1.1-48.10" *)
module \$paramod\read_logic\MEM_SIZE=16 (fifo_synth_rd, fifo_synth_empty, clk, reset_L, rd_ptr, pop);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  wire _21_;
  wire _22_;
  (* src = "FIFO/read_logic.v:10.11-10.14" *)
  input clk;
  (* src = "FIFO/read_logic.v:9.11-9.21" *)
  input fifo_synth_empty;
  (* src = "FIFO/read_logic.v:8.11-8.18" *)
  input fifo_synth_rd;
  (* src = "FIFO/read_logic.v:13.16-13.19" *)
  output pop;
  (* src = "FIFO/read_logic.v:12.28-12.34" *)
  output [4:0] rd_ptr;
  (* src = "FIFO/read_logic.v:11.11-11.18" *)
  input reset_L;
  NOT _23_ (
    .A(rd_ptr[4]),
    .Y(_05_)
  ...
  (* src = "FIFO/read_logic.v:34.1-46.4" *)
  DFF _47_ (
    .C(clk),
    .D(_00_),
    .Q(rd_ptr[0])
...
(* hdlname = "\\read_logic" *)
(* src = "FIFO/read_logic.v:1.1-48.10" *)
module \$paramod\read_logic\MEM_SIZE=4 (fifo_synth_rd, fifo_synth_empty, clk, reset_L, rd_ptr, pop);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
...
(* dynports =  1  *)
(* hdlname = "\\write_logic" *)
(* src = "FIFO/write_logic.v:1.1-48.10" *)
module \$paramod\write_logic\MEM_SIZE=16 (fifo_synth_wr, fifo_synth_full, clk, reset_L, wr_ptr, push);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
  ...
  wire _21_;
  wire _22_;
  (* src = "FIFO/write_logic.v:10.11-10.14" *)
  input clk;
  (* src = "FIFO/write_logic.v:9.11-9.20" *)
  input fifo_synth_full;
  (* src = "FIFO/write_logic.v:8.11-8.18" *)
  input fifo_synth_wr;
  (* src = "FIFO/write_logic.v:13.16-13.20" *)
  output push;
  (* src = "FIFO/write_logic.v:11.11-11.18" *)
  input reset_L;
  (* src = "FIFO/write_logic.v:12.28-12.34" *)
  output [4:0] wr_ptr;
  NOT _23_ (
    .A(wr_ptr[4]),
    .Y(_05_)
  ...
  (* src = "FIFO/write_logic.v:32.1-44.4" *)
  DFF _47_ (
    .C(clk),
    .D(_00_),
    .Q(wr_ptr[0])
...
(* hdlname = "\\write_logic" *)
(* src = "FIFO/write_logic.v:1.1-48.10" *)
module \$paramod\write_logic\MEM_SIZE=4 (fifo_synth_wr, fifo_synth_full, clk, reset_L, wr_ptr, push);
  wire _00_;
  wire _01_;
  wire _02_;
  wire _03_;
...
(* src = "Logica/Empty_and_pause_synth.v:1.1-37.10" *)
module Empty_and_pause_synth(clk, reset_L, vc0_empty, vc1_empty, pause_d0, pause_d1, valid_vc0, valid_vc1, pop_vc0, pop_vc1);
  ...
  (* src = "Logica/Empty_and_pause_synth.v:26.5-35.8" *)
  DFF _14_ (
    .C(clk),
    .D(_00_),
    .Q(valid_vc1)
...
module PCIe_synth(reset, clk, init, umbral_M_full, umbral_M_empty, umbral_V_full, umbral_V_empty, umbral_D_full, umbral_D_empty, data_in, push_data_in, pop_D0, pop_D1, data_out0_synth, data_out1_synth, error_out_synth, active_out_synth, idle_out_synth, errors_synth, MAIN_FIFO_pause_synth, almost_empty_d0_synth, almost_empty_d1_synth);
  ...
  (* src = "PCIe_synth.v:207.5-207.10" *)
  wire flag0;
  (* src = "PCIe_synth.v:208.5-208.10" *)
  wire flag1;
