...
(* dynports =  1  *)
(* src = "control_logic_synth.v:1.1-91.10" *)
module control_logic_synth(full_threshold, empty_threshold, fifo_rd, fifo_wr, clk, reset_L, error_synth, almost_empty_synth, almost_full_synth, fifo_full_synth, fifo_empty_synth);
  ...
  (* src = "control_logic_synth.v:48.1-89.4" *)
  DFF _304_ (
    .C(clk),
    .D(_127_),
    .Q(fifo_empty_synth)
...
module read_logic_synth(fifo_rd, fifo_empty_synth, clk, reset_L, rd_ptr, pop);
  ...
  wire _29_;
  wire _30_;
  (* src = "read_logic_synth.v:19.24-19.35" *)
  wire _31_;
  wire [2:0] _32_;
  (* force_downto = 32'd1 *)
  (* src = "read_logic_synth.v:40.23-40.33|write_logic_synth.v:38.23-38.33|/usr/local/bin/../share/yosys/techmap.v:274.23-274.25" *)
  (* unused_bits = "2" *)
  wire [31:0] _33_;
  (* force_downto = 32'd1 *)
  (* src = "read_logic_synth.v:40.23-40.33|write_logic_synth.v:38.23-38.33|/usr/local/bin/../share/yosys/techmap.v:270.23-270.24" *)
  wire [31:0] _34_;
  (* force_downto = 32'd1 *)
  (* src = "read_logic_synth.v:40.23-40.33|write_logic_synth.v:38.23-38.33|/usr/local/bin/../share/yosys/techmap.v:270.26-270.27" *)
  (* unused_bits = "3" *)
  wire [31:0] _35_;
  ...
  (* src = "read_logic_synth.v:34.1-46.4" *)
  DFF _51_ (
    .C(clk),
    .D(_24_),
    .Q(rd_ptr[0])
...
module write_logic_synth(fifo_wr, fifo_full_synth, clk, reset_L, wr_ptr, push);
  ...
  wire _29_;
  wire _30_;
  (* src = "write_logic_synth.v:19.24-19.34" *)
  wire _31_;
  wire [2:0] _32_;
  (* force_downto = 32'd1 *)
  ...
  (* src = "write_logic_synth.v:32.1-44.4" *)
  DFF _51_ (
    .C(clk),
    .D(_24_),
    .Q(wr_ptr[0])
